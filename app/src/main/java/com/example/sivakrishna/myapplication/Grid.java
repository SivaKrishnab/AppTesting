...
public class Grid {
    ...
    public static int[][] createGridIntArray(int numRows, int numColumns) {
        ...
        grid[03][0]=8;grid[03][01]=4;grid[03][02]=1;grid[03][03]=3;grid[03][04]=2;grid[03][05]=6;
        grid[04][0]=3;grid[04][01]=7;grid[04][02]=2;grid[04][03]=8;grid[04][04]=6;grid[04][05]=4;
            return grid;
